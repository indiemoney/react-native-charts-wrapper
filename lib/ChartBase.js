...
const chartIface = {
  propTypes: {
    ...
    imageMarker: PropTypes.shape({
      ...
      excludes: PropTypes.arrayOf(PropTypes.shape({
        dataIndex: PropTypes.number.isRequired,
        dataSetIndexes: PropTypes.arrayOf(PropTypes.number)
      }))
    }),
    ...
    highlightValue: PropTypes.shape({
      ...
      callListener: PropTypes.bool,
      dataIndex: PropTypes.number
    }),

    highlightEnabled: PropTypes.arrayOf(PropTypes.shape({
      dataSetIndex: PropTypes.number,
      dataIndex: PropTypes.number,
      enabled: PropTypes.bool.isRequired
    })),

    updatedEntries: PropTypes.arrayOf(PropTypes.shape({
      dataSetIndex: PropTypes.number,
      dataIndex: PropTypes.number,
      ...
      removes: PropTypes.arrayOf(PropTypes.shape({
        x: PropTypes.number.isRequired,
        y: PropTypes.number
      }))
    })),

    highlightIndicators: PropTypes.arrayOf(PropTypes.shape({
      dataSetIndex: PropTypes.number,
      dataIndex: PropTypes.number,
